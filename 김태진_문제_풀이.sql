...
select ename 사원이름, job 직책, hiredate 입사날짜, dno 부서번호
from employee
...
select ename 사원이름, job 직책, salary * 12 + nvl(commission, 0) 연봉, dno 부서번호
from employee
...
select dno 부서번호, ename 사원이름, job 직책, eno 사원번호
from employee
